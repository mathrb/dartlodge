...
return checkoutPractice(_that.competitorName,_that.attempts,_that.successes,_that.dartsThrown,_that.fromScore,_that.targetSuccesses,_that.targetMode,_that.fixedTarget,_that.minTarget,_that.maxTarget);case ShanghaiResult() when shanghai != null:
...
return checkoutPractice(_that.competitorName,_that.attempts,_that.successes,_that.dartsThrown,_that.fromScore,_that.targetSuccesses,_that.targetMode,_that.fixedTarget,_that.minTarget,_that.maxTarget);case ShanghaiResult():
...
class CheckoutPracticeResult implements GameResult {
  const CheckoutPracticeResult({required this.competitorName, required this.attempts, required this.successes, required this.dartsThrown, required this.fromScore, this.targetSuccesses, this.targetMode = 'fixed', this.fixedTarget = 170, this.minTarget = 40, this.maxTarget = 170, final  String? $type}): $type = $type ?? 'checkoutPractice';
...
@JsonKey() final  String targetMode;
...
@useResult
$Res call({
 String competitorName, int attempts, int successes, int dartsThrown, int fromScore, int? targetSuccesses, String targetMode, int fixedTarget, int minTarget, int maxTarget
});
...
/// Create a copy of GameResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? competitorName = null,Object? attempts = null,Object? successes = null,Object? dartsThrown = null,Object? fromScore = null,Object? targetSuccesses = freezed,Object? targetMode = null,Object? fixedTarget = null,Object? minTarget = null,Object? maxTarget = null,}) {
...
as int,targetSuccesses: freezed == targetSuccesses ? _self.targetSuccesses : targetSuccesses // ignore: cast_nullable_to_non_nullable
