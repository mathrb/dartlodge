...
mixin _$GameState {
 ...
 String get gameId; GameType get gameType; List<CompetitorState> get competitors; int get currentTurnIndex; int get dartsThrownInTurn; bool get isComplete; String? get winnerCompetitorId; GameEngineStatus get status; bool get turnActive; int get legsToWin; int get currentLegIndex; int get currentRoundInLeg; int? get x01TotalRounds; int? get cricketTotalRounds; String get inStrategy; String get outStrategy; int get startingScore; String get cricketScoring; String get cricketTargetMode; List<int> get cricketTargets; Set<int> get cricketLockedTargets; String get aroundTheClockVariant; int get shanghaiTotalRounds; int get catch40TargetRemaining; int get catch40DartsOnTarget; int? get checkoutTargetSuccesses; String get checkoutTargetMode; int get checkoutFixedTarget; int get checkoutMinTarget; int get checkoutMaxTarget; int get checkoutProgressionStep; int? get countUpTotalRounds;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GameState&&(identical(other.gameId, gameId) || other.gameId == gameId)&&(identical(other.gameType, gameType) || other.gameType == gameType)&&const DeepCollectionEquality().equals(other.competitors, competitors)&&(identical(other.currentTurnIndex, currentTurnIndex) || other.currentTurnIndex == currentTurnIndex)&&(identical(other.dartsThrownInTurn, dartsThrownInTurn) || other.dartsThrownInTurn == dartsThrownInTurn)&&(identical(other.isComplete, isComplete) || other.isComplete == isComplete)&&(identical(other.winnerCompetitorId, winnerCompetitorId) || other.winnerCompetitorId == winnerCompetitorId)&&(identical(other.status, status) || other.status == status)&&(identical(other.turnActive, turnActive) || other.turnActive == turnActive)&&(identical(other.legsToWin, legsToWin) || other.legsToWin == legsToWin)&&(identical(other.currentLegIndex, currentLegIndex) || other.currentLegIndex == currentLegIndex)&&(identical(other.currentRoundInLeg, currentRoundInLeg) || other.currentRoundInLeg == currentRoundInLeg)&&(identical(other.x01TotalRounds, x01TotalRounds) || other.x01TotalRounds == x01TotalRounds)&&(identical(other.cricketTotalRounds, cricketTotalRounds) || other.cricketTotalRounds == cricketTotalRounds)&&(identical(other.inStrategy, inStrategy) || other.inStrategy == inStrategy)&&(identical(other.outStrategy, outStrategy) || other.outStrategy == outStrategy)&&(identical(other.startingScore, startingScore) || other.startingScore == startingScore)&&(identical(other.cricketScoring, cricketScoring) || other.cricketScoring == cricketScoring)&&(identical(other.cricketTargetMode, cricketTargetMode) || other.cricketTargetMode == cricketTargetMode)&&const DeepCollectionEquality().equals(other.cricketTargets, cricketTargets)&&const DeepCollectionEquality().equals(other.cricketLockedTargets, cricketLockedTargets)&&(identical(other.aroundTheClockVariant, aroundTheClockVariant) || other.aroundTheClockVariant == aroundTheClockVariant)&&(identical(other.shanghaiTotalRounds, shanghaiTotalRounds) || other.shanghaiTotalRounds == shanghaiTotalRounds)&&(identical(other.catch40TargetRemaining, catch40TargetRemaining) || other.catch40TargetRemaining == catch40TargetRemaining)&&(identical(other.catch40DartsOnTarget, catch40DartsOnTarget) || other.catch40DartsOnTarget == catch40DartsOnTarget)&&(identical(other.checkoutTargetSuccesses, checkoutTargetSuccesses) || other.checkoutTargetSuccesses == checkoutTargetSuccesses)&&(identical(other.checkoutTargetMode, checkoutTargetMode) || other.checkoutTargetMode == checkoutTargetMode)&&(identical(other.checkoutFixedTarget, checkoutFixedTarget) || other.checkoutFixedTarget == checkoutFixedTarget)&&(identical(other.checkoutMinTarget, checkoutMinTarget) || other.checkoutMinTarget == checkoutMinTarget)&&(identical(other.checkoutMaxTarget, checkoutMaxTarget) || other.checkoutMaxTarget == checkoutMaxTarget)&&(identical(other.checkoutProgressionStep, checkoutProgressionStep) || other.checkoutProgressionStep == checkoutProgressionStep)&&(identical(other.countUpTotalRounds, countUpTotalRounds) || other.countUpTotalRounds == countUpTotalRounds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,gameId,gameType,const DeepCollectionEquality().hash(competitors),currentTurnIndex,dartsThrownInTurn,isComplete,winnerCompetitorId,status,turnActive,legsToWin,currentLegIndex,currentRoundInLeg,x01TotalRounds,cricketTotalRounds,inStrategy,outStrategy,startingScore,cricketScoring,cricketTargetMode,const DeepCollectionEquality().hash(cricketTargets),const DeepCollectionEquality().hash(cricketLockedTargets),aroundTheClockVariant,shanghaiTotalRounds,catch40TargetRemaining,catch40DartsOnTarget,checkoutTargetSuccesses,checkoutTargetMode,checkoutFixedTarget,checkoutMinTarget,checkoutMaxTarget,checkoutProgressionStep,countUpTotalRounds]);

@override
String toString() {
  return 'GameState(gameId: $gameId, gameType: $gameType, competitors: $competitors, currentTurnIndex: $currentTurnIndex, dartsThrownInTurn: $dartsThrownInTurn, isComplete: $isComplete, winnerCompetitorId: $winnerCompetitorId, status: $status, turnActive: $turnActive, legsToWin: $legsToWin, currentLegIndex: $currentLegIndex, currentRoundInLeg: $currentRoundInLeg, x01TotalRounds: $x01TotalRounds, cricketTotalRounds: $cricketTotalRounds, inStrategy: $inStrategy, outStrategy: $outStrategy, startingScore: $startingScore, cricketScoring: $cricketScoring, cricketTargetMode: $cricketTargetMode, cricketTargets: $cricketTargets, cricketLockedTargets: $cricketLockedTargets, aroundTheClockVariant: $aroundTheClockVariant, shanghaiTotalRounds: $shanghaiTotalRounds, catch40TargetRemaining: $catch40TargetRemaining, catch40DartsOnTarget: $catch40DartsOnTarget, checkoutTargetSuccesses: $checkoutTargetSuccesses, checkoutTargetMode: $checkoutTargetMode, checkoutFixedTarget: $checkoutFixedTarget, checkoutMinTarget: $checkoutMinTarget, checkoutMaxTarget: $checkoutMaxTarget, checkoutProgressionStep: $checkoutProgressionStep, countUpTotalRounds: $countUpTotalRounds)';
}
...
@useResult
$Res call({
 String gameId, GameType gameType, List<CompetitorState> competitors, int currentTurnIndex, int dartsThrownInTurn, bool isComplete, String? winnerCompetitorId, GameEngineStatus status, bool turnActive, int legsToWin, int currentLegIndex, int currentRoundInLeg, int? x01TotalRounds, int? cricketTotalRounds, String inStrategy, String outStrategy, int startingScore, String cricketScoring, String cricketTargetMode, List<int> cricketTargets, Set<int> cricketLockedTargets, String aroundTheClockVariant, int shanghaiTotalRounds, int catch40TargetRemaining, int catch40DartsOnTarget, int? checkoutTargetSuccesses, String checkoutTargetMode, int checkoutFixedTarget, int checkoutMinTarget, int checkoutMaxTarget, int checkoutProgressionStep, int? countUpTotalRounds
});
...
/// Create a copy of GameState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? gameId = null,Object? gameType = null,Object? competitors = null,Object? currentTurnIndex = null,Object? dartsThrownInTurn = null,Object? isComplete = null,Object? winnerCompetitorId = freezed,Object? status = null,Object? turnActive = null,Object? legsToWin = null,Object? currentLegIndex = null,Object? currentRoundInLeg = null,Object? x01TotalRounds = freezed,Object? cricketTotalRounds = freezed,Object? inStrategy = null,Object? outStrategy = null,Object? startingScore = null,Object? cricketScoring = null,Object? cricketTargetMode = null,Object? cricketTargets = null,Object? cricketLockedTargets = null,Object? aroundTheClockVariant = null,Object? shanghaiTotalRounds = null,Object? catch40TargetRemaining = null,Object? catch40DartsOnTarget = null,Object? checkoutTargetSuccesses = freezed,Object? checkoutTargetMode = null,Object? checkoutFixedTarget = null,Object? checkoutMinTarget = null,Object? checkoutMaxTarget = null,Object? checkoutProgressionStep = null,Object? countUpTotalRounds = freezed,}) {
...
as int,cricketScoring: null == cricketScoring ? _self.cricketScoring : cricketScoring // ignore: cast_nullable_to_non_nullable
as String,cricketTargetMode: null == cricketTargetMode ? _self.cricketTargetMode : cricketTargetMode // ignore: cast_nullable_to_non_nullable
as String,cricketTargets: null == cricketTargets ? _self.cricketTargets : cricketTargets // ignore: cast_nullable_to_non_nullable
as List<int>,cricketLockedTargets: null == cricketLockedTargets ? _self.cricketLockedTargets : cricketLockedTargets // ignore: cast_nullable_to_non_nullable
as Set<int>,aroundTheClockVariant: null == aroundTheClockVariant ? _self.aroundTheClockVariant : aroundTheClockVariant // ignore: cast_nullable_to_non_nullable
...
as int,checkoutTargetSuccesses: freezed == checkoutTargetSuccesses ? _self.checkoutTargetSuccesses : checkoutTargetSuccesses // ignore: cast_nullable_to_non_nullable
as int?,checkoutTargetMode: null == checkoutTargetMode ? _self.checkoutTargetMode : checkoutTargetMode // ignore: cast_nullable_to_non_nullable
as String,checkoutFixedTarget: null == checkoutFixedTarget ? _self.checkoutFixedTarget : checkoutFixedTarget // ignore: cast_nullable_to_non_nullable
as int,checkoutMinTarget: null == checkoutMinTarget ? _self.checkoutMinTarget : checkoutMinTarget // ignore: cast_nullable_to_non_nullable
as int,checkoutMaxTarget: null == checkoutMaxTarget ? _self.checkoutMaxTarget : checkoutMaxTarget // ignore: cast_nullable_to_non_nullable
as int,checkoutProgressionStep: null == checkoutProgressionStep ? _self.checkoutProgressionStep : checkoutProgressionStep // ignore: cast_nullable_to_non_nullable
as int,countUpTotalRounds: freezed == countUpTotalRounds ? _self.countUpTotalRounds : countUpTotalRounds // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
...
class _GameState implements GameState {
  const _GameState({required this.gameId, required this.gameType, required final  List<CompetitorState> competitors, required this.currentTurnIndex, required this.dartsThrownInTurn, required this.isComplete, this.winnerCompetitorId, this.status = GameEngineStatus.initialized, this.turnActive = false, this.legsToWin = 1, this.currentLegIndex = 0, this.currentRoundInLeg = 1, this.x01TotalRounds, this.cricketTotalRounds, this.inStrategy = 'straight', this.outStrategy = 'double', this.startingScore = 501, this.cricketScoring = 'standard', this.cricketTargetMode = 'fixed', final  List<int> cricketTargets = const <int>[15, 16, 17, 18, 19, 20], final  Set<int> cricketLockedTargets = const <int>{}, this.aroundTheClockVariant = 'standard', this.shanghaiTotalRounds = 7, this.catch40TargetRemaining = 0, this.catch40DartsOnTarget = 0, this.checkoutTargetSuccesses, this.checkoutTargetMode = 'fixed', this.checkoutFixedTarget = 170, this.checkoutMinTarget = 40, this.checkoutMaxTarget = 170, this.checkoutProgressionStep = 10, this.countUpTotalRounds}): _competitors = competitors,_cricketTargets = cricketTargets,_cricketLockedTargets = cricketLockedTargets;
...
@override@JsonKey() final  String cricketScoring;
@override@JsonKey() final  String cricketTargetMode;
 final  List<int> _cricketTargets;
@override@JsonKey() List<int> get cricketTargets {
  if (_cricketTargets is EqualUnmodifiableListView) return _cricketTargets;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_cricketTargets);
}

 final  Set<int> _cricketLockedTargets;
@override@JsonKey() Set<int> get cricketLockedTargets {
  if (_cricketLockedTargets is EqualUnmodifiableSetView) return _cricketLockedTargets;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableSetView(_cricketLockedTargets);
}
...
@override final  int? checkoutTargetSuccesses;
@override@JsonKey() final  String checkoutTargetMode;
@override@JsonKey() final  int checkoutFixedTarget;
@override@JsonKey() final  int checkoutMinTarget;
@override@JsonKey() final  int checkoutMaxTarget;
@override@JsonKey() final  int checkoutProgressionStep;
@override final  int? countUpTotalRounds;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GameState&&(identical(other.gameId, gameId) || other.gameId == gameId)&&(identical(other.gameType, gameType) || other.gameType == gameType)&&const DeepCollectionEquality().equals(other._competitors, _competitors)&&(identical(other.currentTurnIndex, currentTurnIndex) || other.currentTurnIndex == currentTurnIndex)&&(identical(other.dartsThrownInTurn, dartsThrownInTurn) || other.dartsThrownInTurn == dartsThrownInTurn)&&(identical(other.isComplete, isComplete) || other.isComplete == isComplete)&&(identical(other.winnerCompetitorId, winnerCompetitorId) || other.winnerCompetitorId == winnerCompetitorId)&&(identical(other.status, status) || other.status == status)&&(identical(other.turnActive, turnActive) || other.turnActive == turnActive)&&(identical(other.legsToWin, legsToWin) || other.legsToWin == legsToWin)&&(identical(other.currentLegIndex, currentLegIndex) || other.currentLegIndex == currentLegIndex)&&(identical(other.currentRoundInLeg, currentRoundInLeg) || other.currentRoundInLeg == currentRoundInLeg)&&(identical(other.x01TotalRounds, x01TotalRounds) || other.x01TotalRounds == x01TotalRounds)&&(identical(other.cricketTotalRounds, cricketTotalRounds) || other.cricketTotalRounds == cricketTotalRounds)&&(identical(other.inStrategy, inStrategy) || other.inStrategy == inStrategy)&&(identical(other.outStrategy, outStrategy) || other.outStrategy == outStrategy)&&(identical(other.startingScore, startingScore) || other.startingScore == startingScore)&&(identical(other.cricketScoring, cricketScoring) || other.cricketScoring == cricketScoring)&&(identical(other.cricketTargetMode, cricketTargetMode) || other.cricketTargetMode == cricketTargetMode)&&const DeepCollectionEquality().equals(other._cricketTargets, _cricketTargets)&&const DeepCollectionEquality().equals(other._cricketLockedTargets, _cricketLockedTargets)&&(identical(other.aroundTheClockVariant, aroundTheClockVariant) || other.aroundTheClockVariant == aroundTheClockVariant)&&(identical(other.shanghaiTotalRounds, shanghaiTotalRounds) || other.shanghaiTotalRounds == shanghaiTotalRounds)&&(identical(other.catch40TargetRemaining, catch40TargetRemaining) || other.catch40TargetRemaining == catch40TargetRemaining)&&(identical(other.catch40DartsOnTarget, catch40DartsOnTarget) || other.catch40DartsOnTarget == catch40DartsOnTarget)&&(identical(other.checkoutTargetSuccesses, checkoutTargetSuccesses) || other.checkoutTargetSuccesses == checkoutTargetSuccesses)&&(identical(other.checkoutTargetMode, checkoutTargetMode) || other.checkoutTargetMode == checkoutTargetMode)&&(identical(other.checkoutFixedTarget, checkoutFixedTarget) || other.checkoutFixedTarget == checkoutFixedTarget)&&(identical(other.checkoutMinTarget, checkoutMinTarget) || other.checkoutMinTarget == checkoutMinTarget)&&(identical(other.checkoutMaxTarget, checkoutMaxTarget) || other.checkoutMaxTarget == checkoutMaxTarget)&&(identical(other.checkoutProgressionStep, checkoutProgressionStep) || other.checkoutProgressionStep == checkoutProgressionStep)&&(identical(other.countUpTotalRounds, countUpTotalRounds) || other.countUpTotalRounds == countUpTotalRounds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,gameId,gameType,const DeepCollectionEquality().hash(_competitors),currentTurnIndex,dartsThrownInTurn,isComplete,winnerCompetitorId,status,turnActive,legsToWin,currentLegIndex,currentRoundInLeg,x01TotalRounds,cricketTotalRounds,inStrategy,outStrategy,startingScore,cricketScoring,cricketTargetMode,const DeepCollectionEquality().hash(_cricketTargets),const DeepCollectionEquality().hash(_cricketLockedTargets),aroundTheClockVariant,shanghaiTotalRounds,catch40TargetRemaining,catch40DartsOnTarget,checkoutTargetSuccesses,checkoutTargetMode,checkoutFixedTarget,checkoutMinTarget,checkoutMaxTarget,checkoutProgressionStep,countUpTotalRounds]);
...
as int,cricketScoring: null == cricketScoring ? _self.cricketScoring : cricketScoring // ignore: cast_nullable_to_non_nullable
as String,cricketTargetMode: null == cricketTargetMode ? _self.cricketTargetMode : cricketTargetMode // ignore: cast_nullable_to_non_nullable
as String,cricketTargets: null == cricketTargets ? _self._cricketTargets : cricketTargets // ignore: cast_nullable_to_non_nullable
as List<int>,cricketLockedTargets: null == cricketLockedTargets ? _self._cricketLockedTargets : cricketLockedTargets // ignore: cast_nullable_to_non_nullable
as Set<int>,aroundTheClockVariant: null == aroundTheClockVariant ? _self.aroundTheClockVariant : aroundTheClockVariant // ignore: cast_nullable_to_non_nullable
as String,shanghaiTotalRounds: null == shanghaiTotalRounds ? _self.shanghaiTotalRounds : shanghaiTotalRounds // ignore: cast_nullable_to_non_nullable
as int,catch40TargetRemaining: null == catch40TargetRemaining ? _self.catch40TargetRemaining : catch40TargetRemaining // ignore: cast_nullable_to_non_nullable
as int,catch40DartsOnTarget: null == catch40DartsOnTarget ? _self.catch40DartsOnTarget : catch40DartsOnTarget // ignore: cast_nullable_to_non_nullable
...
@useResult
$Res call({
 String competitorId, String name, List<String> playerIds, int score, bool isComplete, List<String> dartThrows, bool isIn, int legsWon, int? turnStartScore, Map<String, int> marksPerNumber, int? closeOrder, int? currentTarget, int practiceRound, int practiceAttempts, int practiceSuccesses, int startingScore
});
...
as int,startingScore: null == startingScore ? _self.startingScore : startingScore // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class _CompetitorState implements CompetitorState {
  const _CompetitorState({required this.competitorId, required this.name, required final  List<String> playerIds, required this.score, this.isComplete = false, final  List<String> dartThrows = const [], this.isIn = false, this.legsWon = 0, this.turnStartScore, final  Map<String, int> marksPerNumber = const <String, int>{}, this.closeOrder, this.currentTarget, this.practiceRound = 1, this.practiceAttempts = 0, this.practiceSuccesses = 0, this.startingScore = 0}): _playerIds = playerIds,_dartThrows = dartThrows,_marksPerNumber = marksPerNumber;
