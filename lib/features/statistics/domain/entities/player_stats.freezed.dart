...
// when no attempts recorded). Values are percentages (0–100).
 double? get doubleOutSuccessRate; double? get firstDartInSuccessRate;// Cricket-specific fields (null for non-cricket games)
