...
## Field limits & conventions

- **App name:** ≤ 30 characters. Same in every locale: **DartLodge**.
...
STATISTICS
• 3-dart averages and first-nine averages
• Checkout percentage and highest checkout
• Cricket marks per round (MPR)
• Score and mark distributions
• Dart-impact heatmaps
• Full game history with per-leg breakdowns
• Per-player and all-time stats
...
STATISTIQUES
• Moyennes à 3 fléchettes et des neuf premières
• Pourcentage de checkout et meilleur checkout
• Marques par tour au Cricket (MPR)
• Répartition des scores et des marques
• Cartes de chaleur des impacts
• Historique complet avec détail par manche
• Statistiques par joueur et de tous les temps
...
```
Dardos: puntuación y estadísticas, gratis y sin conexión. X01, Cricket y más.
```

**Full description**

```
DartLodge es una aplicación de puntuación de dardos gratuita y de código abierto que guarda todo en tu dispositivo: sin cuenta, sin anuncios y sin rastreo.

Anota todos los juegos clásicos y modos de práctica, y consulta estadísticas detalladas que se actualizan automáticamente.

JUEGOS
• X01 (301 / 501 / 701…) con entrada/salida a doble o master
• Cricket: estándar, cut-throat y sin puntuación, con objetivos fijos, aleatorios o «crazy»
• Around the Clock
• Bob's 27
• Catch 40
• Shanghai
...
ESTADÍSTICAS
• Promedios de 3 dardos y de los primeros nueve
• Porcentaje de checkout y mejor checkout
• Marcas por ronda en Cricket (MPR)
• Distribución de puntuaciones y marcas
• Mapas de calor de los impactos
• Historial completo con desglose por leg
• Estadísticas por jugador y de todos los tiempos
...
STATISTIKEN
• 3-Dart-Average und First-Nine-Average
• Checkout-Quote und höchstes Checkout
• Marks pro Runde im Cricket (MPR)
• Verteilung von Punkten und Marks
• Heatmaps der Treffer
• Vollständiger Verlauf mit Aufschlüsselung pro Leg
• Statistiken pro Spieler und insgesamt
...
ESTATÍSTICAS
• Médias de 3 dardos e dos primeiros nove
• Percentagem de checkout e melhor checkout
• Marcas por ronda no Cricket (MPR)
• Distribuição de pontuações e marcas
• Mapas de calor dos impactos
• Histórico completo com detalhe por leg
• Estatísticas por jogador e de todos os tempos
...
```
DartLodge è un'app per il punteggio delle freccette gratuita e open-source che tiene tutto sul tuo dispositivo: niente account, niente pubblicità, niente tracciamento.

Segna i punti di tutti i giochi classici e le modalità di allenamento e consulta statistiche dettagliate che si aggiornano automaticamente.
...
STATISTICHE
• Medie a 3 freccette e dei primi nove
• Percentuale di checkout e checkout più alto
• Marcature per round nel Cricket (MPR)
• Distribuzione di punteggi e marcature
• Mappe di calore degli impatti
• Cronologia completa con dettaglio per leg
• Statistiche per giocatore e di sempre
...
STATISTIEKEN
• 3-darts-gemiddelden en first-nine-gemiddelden
• Checkout-percentage en hoogste checkout
• Marks per ronde bij Cricket (MPR)
• Verdeling van scores en marks
• Heatmaps van inslagen
• Volledige geschiedenis met uitsplitsing per leg
• Statistieken per speler en aller tijden
