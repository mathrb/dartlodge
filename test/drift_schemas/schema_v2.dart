...
class UnlockedAchievements extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  UnlockedAchievements(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> playerId = GeneratedColumn<String>(
    'player_id',
    aliasedName,
    false,
    ...
    requiredDuringInsert: true,
    $customConstraints:
        'NOT NULL REFERENCES players(player_id)ON DELETE CASCADE',
  );
  ...
  late final GeneratedColumn<String> gameId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NULL REFERENCES games(game_id)ON DELETE SET NULL',
  );
  @override
  List<GeneratedColumn> get $columns => [
    playerId,
  ...
  @override
  UnlockedAchievements createAlias(String alias) {
    return UnlockedAchievements(attachedDatabase, alias);
  }
...
class DatabaseAtV2 extends GeneratedDatabase {
  ...
  late final UnlockedAchievements unlockedAchievements = UnlockedAchievements(
    this,
  );
